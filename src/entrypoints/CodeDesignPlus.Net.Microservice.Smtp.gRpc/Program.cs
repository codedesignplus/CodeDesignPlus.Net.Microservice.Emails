...
using CodeDesignPlus.Net.Microservice.Smtp.gRpc.Services;
...
builder.Services.AddMediatR<CodeDesignPlus.Net.Microservice.Smtp.Application.Startup>();
builder.Services.AddFluentValidation();

builder.Services.AddMongo<CodeDesignPlus.Net.Microservice.Smtp.Infrastructure.Startup>(builder.Configuration);
builder.Services.AddRedis(builder.Configuration);
builder.Services.AddRabbitMQ<CodeDesignPlus.Net.Microservice.Smtp.Domain.Startup>(builder.Configuration);
